                        ...
                        <div class="top-info-wrap text-left text-black">
                            <ul class="address-info">
                                <li>
                                    ...
                                    <a href="evergreen@gmail.com">(1245) 2456 012</a>
                                </li>
                                <li>
                                    <i class="fa fa-envelope"></i>
                                    <a href="evergreen@gmail.com">evergreen@gmail.com</a>
                                </li>
                            </ul>
            ...
            <div class="swiper-wrapper">
                <div class="intro11-section swiper-slide slide-1 slide-bg-1 bg-position">
                    ...
                    <div class="intro11-content text-left">
                        <h3 class="title-slider text-uppercase">Evergreen</h3>
                        <h2 class="title">Natural & Beautiful Flowers</h2>
                        <p class="desc-content">Temukan keindahan bunga segar yang memancarkan pesona alami. Cocok untuk hadiah, dekorasi, atau sekadar menyegarkan suasana hati. Kami menghadirkan rangkaian bunga pilihan dengan kualitas terbaik dan sentuhan estetika yang memikat. </p>
                ...
                <div class="intro11-section swiper-slide slide-2 slide-bg-1 bg-position">
                    ...
                    <div class="intro11-content text-left">
                        ...
                        <p class="desc-content">Menangkap keindahan alam dalam satu genggaman untuk dia yang tersayang.</p>
            ...
            <div class="row">
                <div class="cat-1 col-md-4 col-sm-12 col-custom">
                    <div class="categories-img mb-30">
                        <a href="#"><img src="assets/images/category/home-1category.jpg" alt=""></a>
                ...
                <div class="cat-2 col-md-8 col-sm-12 col-custom">
                    <div class="row">
                        <div class="cat-3 col-md-7 col-custom">
                            <div class="categories-img mb-30">
                                <a href="#"><img src="assets/images/category/home 2 category.jpg" alt=""></a>
                                
                            </div>
                        </div>
                        <div class="cat-4 col-md-5 col-custom">
                            <div class="categories-img mb-30">
                                <a href="#"><img src="assets/images/category/home 3 category.jpg" alt=""></a>
                                
                            </div>
                        </div>
                        <div class="cat-5 col-md-4 col-custom">
                            <div class="categories-img mb-30">
                                <a href="#"><img src="assets/images/category/home -4.jpg" alt=""></a>
                                
                            </div>
                        </div>
                        <div class="cat-6 col-md-8 col-custom">
                            <div class="categories-img mb-30">
                                <a href="#"><img src="assets/images/category/home-5.jpg" alt=""></a>
            ...
            <div class="row">
                <div class="col-lg-8 ml-auto mr-auto">
                    <div class="history-area-content pb-0 mb-0 border-0 text-center">
                        <p><strong>Kami percaya bahwa keindahan alam harus bisa diakses oleh siapa saja, di mana saja, secara instan.Evergreen lahir dari perpaduan antara seni botani dan kenyamanan teknologi. Kami tidak hanya membuat buket; kami menciptakan pengalaman digital untuk merayakan momen hidup Anda.</strong></p>
                        <p>Evergreen adalah platform layanan floral digital yang didedikasikan untuk mengubah setiap momen spesial menjadi kenangan abadi. 
                            Kami percaya bahwa bunga adalah bahasa universal untuk cinta, apresiasi, dan simpati. Melalui sentuhan modern, kami menghadirkan kemudahan memesan bunga berkualitas tinggi secara online. Membantu Anda menyampaikan perasaan yang sulit diungkapkan melalui kata-kata dengan rangkaian bunga segar yang dirancang
                             secara artistik dan dikirimkan dengan penuh ketulusan.</p>
                    </div>
                </div>
            </div>
        </div>
