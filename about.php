                                ...
                                <li class="minicart-wrap">
                                    ...
                                    <div class="cart-item-wrapper dropdown-sidemenu dropdown-hover-2">
                                        <div class="single-cart-item">
                                            <div class="cart-img">
                                                <a href="cart.html"><img src="assets/images/cart/buqet1.jpg" alt=""></a>
                                            </div>
                                            <div class="cart-text">
            ...
            <div class="off-canvas-inner-content">
                <div class="off-canvas-inner">
                    ...
                    <div class="offcanvas-widget-area">
                        ...
                        <p class="desc-content">Kami percaya bahwa keindahan alam harus bisa diakses oleh siapa saja, di mana saja, secara instan.Evergreen lahir dari perpaduan antara seni botani dan kenyamanan teknologi. Kami tidak hanya membuat buket; kami menciptakan pengalaman digital untuk merayakan momen hidup Anda.<br>Evergreen
                                adalah platform layanan floral digital yang didedikasikan untuk mengubah setiap momen spesial menjadi kenangan abadi. Kami percaya bahwa bunga adalah bahasa universal untuk cinta, apresiasi, dan simpati. Melalui sentuhan modern, kami menghadirkan kemudahan memesan bunga berkualitas tinggi secara online.
                                Membantu Anda menyampaikan perasaan yang sulit diungkapkan melalui kata-kata dengan rangkaian bunga segar yang dirancang secara artistik dan dikirimkan dengan penuh ketulusan. <br> </p>
                        <div class="switcher">
                            <div class="language">
                                <span class="switcher-title">Language: </span>
                                <div class="switcher-menu">
                ...
                <div class="col-md-6 col-custom">
                    <div class="collection-content">
                        <div class="section-title text-left">
                            ...
                            <h3 class="section-title-3 pb-0">Bouquet</h3>
                        </div>
                        <div class="desc-content">
                            <p>Lengkapi momen spesialmu dengan simbol keindahan yang tak terlupakan.</p>
                        </div>
                ...
                <div class="col-md-6 col-custom">
                    ...
                    <div class="single-banner hover-style">
                        <div class="banner-img">
                            <a href="#">
                                <img src="assets/images/collection/1bg.jpg" alt="About Image">
            ...
            <div class="row align-items-center">
                <div class="col-md-6 col-custom order-2 order-md-1">
                    ...
                    <div class="single-banner hover-style">
                        <div class="banner-img">
                            <a href="#">
                                <img src="assets/images/collection/2bg.jpg" alt="About Image">
                                <div class="overlay-1"></div>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-custom order-1 order-md-2">
                    <div class="collection-content">
                        <div class="section-title text-left">
                            <span class="section-title-1">Flowers for the</span>
                            <h3 class="section-title-3 pb-0">Flower Board</h3>
                        </div>
                        <div class="desc-content">
                            <p>Keindahan yang tumbuh, kebahagiaan yang dikirim.</p>
                        </div>
                        <a href="shop.html" class="btn flosun-button secondary-btn rounded-0">Shop Collection</a>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-8 ml-auto mr-auto">
                        <div class="history-area-content text-center border-0">
                            <p><strong>Kami percaya bahwa keindahan alam harus bisa diakses oleh siapa saja, di mana saja, secara instan.Evergreen lahir dari perpaduan antara seni botani dan kenyamanan teknologi. Kami tidak hanya membuat buket; kami menciptakan pengalaman digital untuk merayakan momen hidup Anda.Evergreen
                                adalah platform layanan floral digital yang didedikasikan untuk mengubah setiap momen spesial menjadi kenangan abadi. Kami percaya bahwa bunga adalah bahasa universal untuk cinta, apresiasi, dan simpati. Melalui sentuhan modern, kami menghadirkan kemudahan memesan bunga berkualitas tinggi secara online.
                                Membantu Anda menyampaikan perasaan yang sulit diungkapkan melalui kata-kata dengan rangkaian bunga segar yang dirancang secara artistik dan dikirimkan dengan penuh ketulusan.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid-item">
                        <div class="ht-team-member">
                            ...
                            <div class="team-info text-center">
                                <h5 class="name">Maria Sindrini Wea Liu </h5>
                                <div class="position">Mahasiswa IT semester 3</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-custom">
                    <div class="grid-item">
                        <div class="ht-team-member">
                            ...
                            <div class="team-info text-center">
                                <h5 class="name">Tiara Anggita Baso </h5>
                                <div class="position">Mahasiswa IT semester 3</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-4 col-custom">
                    <div class="grid-item">
                        <div class="ht-team-member">
                            ...
                            <div class="team-info text-center">
                                <h5 class="name">Amelia Arini Venan </h5>
                                <div class="position">Mahasiswa IT semester 3</div>
                            </div>
                        </div>
                    </div>
